...
class MaterialManager {
  ...
  getMeshMaterial(color) {
    let c = color.hex && colourNameToHex(color.hex)
...
let Converter = {
  ...
  Mesh(args, cb) {
    ...
    var material = new THREE.MeshBasicMaterial({ color: 0xffffff, side: THREE.DoubleSide, wireframe:true, transparent:true});
